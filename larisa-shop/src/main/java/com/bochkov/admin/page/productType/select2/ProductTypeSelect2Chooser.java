...
public class ProductTypeSelect2Chooser extends Select2Choice<ProductType> {
    ...
    public ProductTypeSelect2Chooser(String id) {
        super(id);
        setProvider(choiceProvider());
    }

    public ProductTypeSelect2Chooser(String id, IModel<ProductType> model) {
        super(id, model);
        setProvider(choiceProvider());
    }
